...
namespace SBRW.Launcher.Core.Extras.Proxy_.Nancy_
{
    internal class Nancy_Gzip_Compression : IApplicationStartup
    {
        ...
        private TextResponse OnError(NancyContext context, Exception Error)
        {
            ...
            Communication_Nancy.RecordEntry(Proxy_Server.Instance.GetServerName(), "PROXY", CommunicationLogEntryType.Error,
        ...
        private static void WebCallRejected(string Reason, NancyContext Context)
        {
            ...
            Communication_Nancy.RecordEntry(Proxy_Server.Instance.GetServerName(), "LAUNCHER", CommunicationLogEntryType.Rejected,
        ...
        private static void CheckForCompression(NancyContext Context)
        {
            ...
            else if (Proxy_Server.Client_Session)
            {
                try
                {
